...
public class GeofenceRequester
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
            ...
            Log.d(GeofenceUtils.APPTAG, "GeofenceRequester:onAddGeofencesResult");
        Toast.makeText(mActivity, "GeofenceRequester onAddGeofencesResult",Toast.LENGTH_SHORT).show();
    ...
    public void onConnected(Bundle arg0) {
        ...
        Toast.makeText(mActivity, "GeofenceRequester onConnected",Toast.LENGTH_SHORT).show();
